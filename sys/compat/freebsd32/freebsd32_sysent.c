...
struct sysent freebsd32_sysent[] = {
	...
	{ .sy_narg = AS(drl_update_prob_args), .sy_call = (sy_call_t *)sys_drl_update_prob, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 588 = drl_update_prob */
	{ .sy_narg = AS(freebsd32_drl_get_buffer_args), .sy_call = (sy_call_t *)freebsd32_drl_get_buffer, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 589 = freebsd32_drl_get_buffer */
};
